...
def keep_sents_with_entities(txt_body: str, entity: str) -> str:
    ...
    sentences_with_entities: List[str] = [
        sent for sent in all_sentences if entity in sent
    ]
...
def main():
    ...
    # rename entity types:
    oracle["entity type"].replace(
        {"branch_name": "B-BRANCH", "file_name": "B-FILE", "issue_number": "B-ISSUE"},
        inplace=True,
    )
